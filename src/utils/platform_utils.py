        ...
        try:
            ...
            try:
                ...
                for hub in c.Win32_USBHub():
                    try:
                        device_info = {
                            "name": hub.Name or "USB Hub",
                            "description": hub.Description or "USB Hub",
                            "device_id": hub.DeviceID or "",
                            "manufacturer": hub.Manufacturer or "Unknown",
                            "status": hub.Status or "OK",
                            "is_connected": True,
                            "device_type": "USB Hub",
